...
if IS_HEROKU:
  ...
  #TWITTER
  MY_TWITTER_ID = os.environ.get('MY_TWITTER_ID', None)
  MY_TWITTER_NAME = os.environ.get('MY_TWITTER_NAME', None)
  TWITTER_CONSUMER_KEY = os.environ.get('TWITTER_CONSUMER_KEY', None)
  TWITTER_CONSUMER_SECRET = os.environ.get('TWITTER_CONSUMER_SECRET', None)
  TWITTER_ACCESS_TOKEN = os.environ.get('TWITTER_ACCESS_TOKEN', None)
  TWITTER_ACCESS_TOKEN_SECRET = os.environ.get('TWITTER_ACCESS_TOKEN_SECRET', None)
  TWITTER_CHARACTER_LIMIT = os.environ.get('TWITTER_CHARACTER_LIMIT', 280)
  MAX_NUMBER_OF_TWEETOUTS_PER_SESSION = os.environ.get('MAX_NUMBER_OF_TWEETOUTS_PER_SESSION', 10)
  ...
  from localconfig import IMAP_LOGIN,IMAP_PASSWORD, WTF_CSRF_ENABLED,SECRET_KEY,TWITTER_CONSUMER_KEY,TWITTER_CONSUMER_SECRET,TWITTER_ACCESS_TOKEN,TWITTER_ACCESS_TOKEN_SECRET,TWITTER_ON,TWITTER_CHARACTER_LIMIT,MAX_NUMBER_OF_TWEETOUTS_PER_SESSION,MY_TWITTER_ID,MY_TWITTER_NAME
