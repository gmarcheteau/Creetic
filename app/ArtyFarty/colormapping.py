...
class ColorNames:
    ...
    @staticmethod
    def cleanName(colorname):
      cleanname = ""
      pos = [i for i,e in enumerate(colorname+'A') if e.isupper()]
      parts = [colorname[pos[j]:pos[j+1]] for j in xrange(len(pos)-1)]
      
      #concatenate
      for part in parts:
        cleanname+=part
        cleanname+=' '
      #remove last space and set lowercase
